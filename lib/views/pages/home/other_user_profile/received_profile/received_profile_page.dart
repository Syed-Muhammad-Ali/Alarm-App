...
class ReceivedProfilePage extends StatefulWidget {
  const ReceivedProfilePage({super.key});

  @override
  State<ReceivedProfilePage> createState() => _ReceivedProfilePageState();
}

class _ReceivedProfilePageState extends State<ReceivedProfilePage> {
