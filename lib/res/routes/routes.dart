...
import 'package:alarm_app/views/pages/profile/account_setting/account_setting_page.dart';
...
class AppRoutes {
  static appRoutes() => [
    ...
    GetPage(name: RouteName.accountSettingPage, page: () => const AccountSettingPage()),
  ];
}
